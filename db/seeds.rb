...
Article.create(:name => 'Understanding animations queues', :small_description => 'You will learn how to handle animation queues.', :category_id => 4, :path => 'selectors', :route => '/app/guides/en/jquery/understanding_animation_queues.txt', :language => 'en', :visits => 0, :image_url => 'jquery.gif', :messages => 0)
