...
Article.create(:name => 'Learn how yo use the Google Maps API - Part 1', :small_description => 'We will see some of the functionalities that GOogle Maps provide us', :category_id => 9, :path => 'how-to-use-the-google-maps-v3-part-1', :route => '/app/guides/en/miscellaneous/how_to_use_the_google_maps_api_v3_part_1.txt', :language => 'en', :visits => 0, :image_url => 'm-icon.png', :messages => 0)
Article.create(:name => 'Learn how yo use the Google Maps API - Part 2', :small_description => 'We will see some of the functionalities that GOogle Maps provide us', :category_id => 9, :path => 'how-to-use-the-google-maps-v3-part-2', :route => '/app/guides/en/miscellaneous/how_to_use_the_google_maps_api_v3_part_2.txt', :language => 'en', :visits => 0, :image_url => 'm-icon.png', :messages => 0)
